                      ...
                      <div class="owner-div row">
                        ...
                        <div class="name">
                          <a class="anchor" id="ownerNameAnchor`+tokenAddress+id+`" href="./profile.html?address=`+owner+`">
                            <div class="owner-name" style="color: aliceblue;" id="ownerName`+tokenAddress+id+`"></div>
                          </a>
                    ...
                    <div class="creator-div row">
                      ...
                      <div class="name">
                        <a class="anchor" href="./profile.html?address=`+creator+`">
                          <div class="creator-name" style="color: aliceblue;" id="creatorName`+tokenAddress+id+`"></div>
                        </a>
